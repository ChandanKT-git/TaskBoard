...
var require_use_sync_external_store_shim_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      var React6 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is2, useState3 = React6.useState, useEffect4 = React6.useEffect, useLayoutEffect3 = React6.useLayoutEffect, useDebugValue2 = React6.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
var require_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React6 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is2, useSyncExternalStore3 = shim.useSyncExternalStore, useRef5 = React6.useRef, useEffect4 = React6.useEffect, useMemo4 = React6.useMemo, useDebugValue2 = React6.useDebugValue;
...
`;
    ...
    if (forwardRef2) {
      const _forwarded = React3.forwardRef(function forwardConnectRef(props, ref2) {
...
var createStore2 = ({
  ...
  announce,
  autoScroller
}) => createStore(reducer, composeEnhancers(applyMiddleware(style(styleMarshal), dimensionMarshalStopper(dimensionMarshal), lift(dimensionMarshal), drop, dropAnimationFinish, dropAnimationFlushOnScroll, pendingDrop$1, autoScroll(autoScroller), scrollListener$1, focus(focusMarshal), responders(getResponders, announce))));
var clean$1 = () => ({
  additions: {},
  removals: {},
  modified: {}
...
var useIsomorphicLayoutEffect2 = typeof window !== "undefined" && typeof window.document !== "undefined" && typeof window.document.createElement !== "undefined" ? import_react4.useLayoutEffect : import_react4.useEffect;
var useLayoutEffect2 = useIsomorphicLayoutEffect2;
var getHead = () => {
...
function useStyleMarshal(contextId, nonce) {
  const styles = useMemo3(() => getStyles$1(contextId), [contextId]);
  const alwaysRef = (0, import_react4.useRef)(null);
  const dynamicRef = (0, import_react4.useRef)(null);
...
function useFocusMarshal(contextId) {
  ...
  const recordRef = (0, import_react4.useRef)(null);
  const restoreFocusFrameRef = (0, import_react4.useRef)(null);
...
function useRegistry() {
  const registry = useMemo3(createRegistry, []);
  (0, import_react4.useEffect)(() => {
    return function unmount() {
      if (import_react4.default.version.startsWith("16") || import_react4.default.version.startsWith("17")) {
...
var StoreContext = import_react4.default.createContext(null);
var getBodyElement = () => {
...
function useAnnouncer(contextId) {
  const id = useMemo3(() => getId(contextId), [contextId]);
  const ref2 = (0, import_react4.useRef)(null);
  (0, import_react4.useEffect)(function setup() {
...
function useDeprecatedUniqueId(prefix3, options = defaults) {
  return useMemo3(() => `${prefix3}${options.separator}${count$1++}`, [options.separator, prefix3]);
}
function useUniqueId(prefix3, options = defaults) {
  const id = import_react4.default.useId();
  return useMemo3(() => `${prefix3}${options.separator}${id}`, [options.separator, prefix3, id]);
}
var useUniqueId$1 = "useId" in import_react4.default ? useUniqueId : useDeprecatedUniqueId;
...
function useHiddenTextElement({
  ...
  const id = useMemo3(() => getElementId({
    contextId,
    uniqueId
  }), [uniqueId, contextId]);
  (0, import_react4.useEffect)(function mount() {
    const el = document.createElement("div");
    el.id = id;
    el.textContent = text;
...
var AppContext = import_react4.default.createContext(null);
...
function useStartupValidation() {
  useDevSetupWarning(() => {
    checkReactVersion(peerDependencies.react, import_react4.default.version);
    checkDoctype(document);
  }, []);
}
function usePrevious(current) {
  const ref2 = (0, import_react4.useRef)(current);
  (0, import_react4.useEffect)(() => {
...
function useMouseSensor(api) {
  const phaseRef = (0, import_react4.useRef)(idle$1);
  const unbindEventsRef = (0, import_react4.useRef)(noop$2);
  const startCaptureBinding = useMemo3(() => ({
    eventName: "mousedown",
  ...
  const preventForcePressBinding = useMemo3(() => ({
  ...
  useLayoutEffect2(function mount() {
    listenForCapture();
    return function unmount() {
      unbindEventsRef.current();
    };
...
function useKeyboardSensor(api) {
  const unbindEventsRef = (0, import_react4.useRef)(noop$1);
  const startCaptureBinding = useMemo3(() => ({
    eventName: "keydown",
...
function useTouchSensor(api) {
  const phaseRef = (0, import_react4.useRef)(idle);
  const unbindEventsRef = (0, import_react4.useRef)(noop$2);
  ...
  useLayoutEffect2(function webkitHack() {
...
function useSensorMarshal({
  ...
  const lockAPI = (0, import_react4.useState)(() => create())[0];
  const tryAbandonLock = useCallback2(function tryAbandonLock2(previous, current) {
    if (isDragging(previous) && !isDragging(current)) {
      lockAPI.tryAbandon();
    }
  }, [lockAPI]);
  useLayoutEffect2(function listenToStore() {
...
function App(props) {
  ...
  const lazyStoreRef = (0, import_react4.useRef)(null);
  ...
  const marshalCallbacks = useMemo3(() => bindActionCreators({
  ...
  const dimensionMarshal = useMemo3(() => {
    return createDimensionMarshal(registry, marshalCallbacks);
  }, [registry, marshalCallbacks]);
  const autoScroller = useMemo3(() => createAutoScroller({
    scrollWindow,
  ...
  const store = useMemo3(() => createStore2({
    announce,
    autoScroller,
    dimensionMarshal,
    focusMarshal,
  ...
  return import_react4.default.createElement(AppContext.Provider, {
    value: appContext
  }, import_react4.default.createElement(Provider_default, {
...
function useDeprecatedUniqueContextId() {
  return useMemo3(() => `${count++}`, []);
}
function useUniqueContextId() {
  return import_react4.default.useId();
}
var useUniqueContextId$1 = "useId" in import_react4.default ? useUniqueContextId : useDeprecatedUniqueContextId;
function resetServerContext() {
  if ("useId" in import_react4.default) {
...
function DragDropContext(props) {
  ...
  return import_react4.default.createElement(ErrorBoundary, null, (setCallbacks) => import_react4.default.createElement(App, {
    nonce: props.nonce,
    contextId,
    setCallbacks,
    dragHandleUsageInstructions: dragHandleUsageInstructions2,
...
function useDraggablePublisher(args) {
  ...
  const entry = useMemo3(() => ({
    uniqueId,
    descriptor,
    options,
    getDimension: getDimension2
  }), [descriptor, getDimension2, options, uniqueId]);
  const publishedRef = (0, import_react4.useRef)(entry);
  const isFirstPublishRef = (0, import_react4.useRef)(true);
  useLayoutEffect2(() => {
...
var DroppableContext = import_react4.default.createContext(null);
...
function useClonePropValidation(isClone) {
  useDev(() => {
    const initialRef = (0, import_react4.useRef)(isClone);
    useDevSetupWarning(() => {
...
function useRequiredContext(Context) {
  const result = (0, import_react4.useContext)(Context);
...
var Draggable = (props) => {
  ...
  const dragHandleProps = useMemo3(() => isEnabled ? {
    tabIndex: 0,
    role: "button",
  ...
  return import_react4.default.createElement(import_react4.default.Fragment, null, children(provided, mapped.snapshot, rubric));
};
...
function PrivateDraggable(props) {
  ...
  return import_react4.default.createElement(ConnectedDraggable$1, props);
}
function PublicDraggable(props) {
  const isEnabled = typeof props.isDragDisabled === "boolean" ? !props.isDragDisabled : true;
  const canDragInteractiveElements = Boolean(props.disableInteractiveElementBlocking);
  const shouldRespectForcePress = Boolean(props.shouldRespectForcePress);
  return import_react4.default.createElement(PrivateDraggable, _extends({}, props, {
    isClone: false,
    isEnabled,
    canDragInteractiveElements,
    shouldRespectForcePress
...
function useDroppablePublisher(args) {
  const whileDraggingRef = (0, import_react4.useRef)(null);
  ...
  const publishedDescriptorRef = (0, import_react4.useRef)(descriptor);
  const memoizedUpdateScroll = useMemo3(() => memoizeOne((x, y) => {
  ...
  const scheduleScrollUpdate = useMemo3(() => raf_schd_esm_default(updateScroll), [updateScroll]);
...
var Placeholder = (props) => {
  const animateOpenTimerRef = (0, import_react4.useRef)(null);
  ...
  const [isAnimatingOpenOnMount, setIsAnimatingOpenOnMount] = (0, import_react4.useState)(props.animate === "open");
  (0, import_react4.useEffect)(() => {
    if (!isAnimatingOpenOnMount) {
      return noop;
    }
  ...
  return import_react4.default.createElement(props.placeholder.tagName, {
    style: style2,
...
var Placeholder$1 = import_react4.default.memo(Placeholder);
...
var AnimateInOut = class extends import_react4.default.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
...
var Droppable = (props) => {
  const appContext = (0, import_react4.useContext)(AppContext);
  !appContext ? true ? invariant2(false, "Could not find app context") : invariant2(false) : void 0;
  const {
    contextId,
    isMovementAllowed: isMovementAllowed2
  } = appContext;
  const droppableRef = (0, import_react4.useRef)(null);
  const placeholderRef = (0, import_react4.useRef)(null);
  const {
    children,
    droppableId,
    type,
  ...
  const placeholder2 = useMemo3(() => import_react4.default.createElement(AnimateInOut, {
    ...
    data,
    animate
  }) => import_react4.default.createElement(Placeholder$1, {
    placeholder: data,
    onClose,
  ...
  const droppableContext = useMemo3(() => ({
    droppableId,
    type,
    isUsingCloneFor
  ...
  function getClone() {
    ...
    const node = import_react4.default.createElement(PrivateDraggable, {
  ...
  return import_react4.default.createElement(DroppableContext.Provider, {
